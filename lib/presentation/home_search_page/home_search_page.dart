...
import 'package:estate_app_mobile/widgets/app_bar/appbar_iconbutton_2.dart';
import 'package:estate_app_mobile/widgets/app_bar/custom_app_bar.dart';
import 'package:estate_app_mobile/widgets/custom_text_form_field.dart';
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller
                        .homeSearchModelObj.value.homeSearchItemList.length,
                    itemBuilder: (context, index) {
                      HomeSearchItemModel model = controller
                          .homeSearchModelObj.value.homeSearchItemList[index];
                      return HomeSearchItemWidget(
                        model,
                      );
                    },
                  ),
